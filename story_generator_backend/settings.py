...
# SQS Queue URLs
WHISPR_TALES_QUEUE_URL = os.getenv('WHISPR_TALES_QUEUE_URL')

CSRF_TRUSTED_ORIGINS = ['http://localhost:5173']

TEST_RAZORPAY_KEY_ID = os.getenv('TEST_RAZORPAY_KEY_ID')
TEST_RAZORPAY_KEY_SECRET = os.getenv('TEST_RAZORPAY_KEY_SECRET')
PROD_RAZORPAY_KEY_ID = os.getenv('PROD_RAZORPAY_KEY_ID')
PROD_RAZORPAY_KEY_SECRET = os.getenv('PROD_RAZORPAY_KEY_SECRET')
